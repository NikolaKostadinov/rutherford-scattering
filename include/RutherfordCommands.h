...
#define GENERATE_ENERGY_CMD		GENERATE_CMD ENERGY_CMD
#define GENERATE_DISTANCE_CMD		GENERATE_CMD DISTANCE_CMD
#define ANALYSIS_ENERGY_TITLE_CMD	ANALYSIS_CMD ENERGY_CMD TITLE_CMD
...
#define ANALYSIS_THETA_TITLE_CMD	ANALYSIS_CMD THETA_CMD  THETA_CMD
#define ANALYSIS_THETA_BINS_CMD		ANALYSIS_CMD THETA_CMD  BINS_CMD
#define ANALYSIS_THETA_MIN_CMD		ANALYSIS_CMD THETA_CMD  MIN_CMD
#define ANALYSIS_THETA_MAX_CMD		ANALYSIS_CMD THETA_CMD  MAX_CMD
